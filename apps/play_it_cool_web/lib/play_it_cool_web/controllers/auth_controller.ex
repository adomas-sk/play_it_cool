defmodule PlayItCoolWeb.AuthController do
  use PlayItCoolWeb, :controller

  def index(conn, %{"provider" => provider}) do
    redirect(conn,
      external: authorize_url!(provider)
    )
  end
  ...
  defp authorize_url!("google") do
    PlayItCoolWeb.OAuth.Google.authorize_url!(scope: "email profile")
  end
  ...
  defp get_token!("google", code) do
    PlayItCoolWeb.OAuth.Google.get_token!(code: code)
  end
